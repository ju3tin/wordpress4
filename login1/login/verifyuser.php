...
<html>
  <head>
    <link href="../../PHP-Login/css/bootstrap.css" rel="stylesheet" media="screen">
    <link href="../../PHP-Login/css/main.css" rel="stylesheet" media="screen">
    <meta charset="UTF-8">
    <title>Verify User</title>
  </head>
  <body>
<?php
require '../../PHP-Login/login/includes/functions.php';
include '../../PHP-Login/login/config.php';
